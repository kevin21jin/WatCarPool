...
-- The user cannot register if either of the username, email address,
-- or phone number is already used by another user.
...
-- We will check ii the count returns 0, if so, then the user can register
